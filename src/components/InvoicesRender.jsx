...
const InvoicesRender = () => {
  ...
  return (
    <div
      id="invoices"
      className="flex flex-col gap-y-2 justify-center flex-grow"
    >
      {(!invoicesExists() && (
        <div
          id="empty-invoices"
          className="flex flex-col flex-grow w-[206px] sm:w-[241px] text-center gap-y-14 self-center justify-center"
        >
        ...
        <div
          id="problematico"
          className="flex flex-col h-[550px] gap-y-4 pr-1 overflow-y-scroll"
        >
          {invoices.map(
            (invoice, index) =>
